...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WhiffTestFramework
    pass

class ExampleTest(WhiffTestFramework):
    # Each functional test is a subclass of the WhiffTestFramework class.
    ...
    def custom_method(self):
        ...
        WhiffTestFramework class so other tests can use it."""
