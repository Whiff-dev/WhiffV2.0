...
# TestNode: A peer we use to send messages to whiffd, and store responses.
...
class CompactBlocksTest(WhiffTestFramework):
    ...
    # This test actually causes whiffd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that whiffd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for whiffd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # whiffd will not send blocktxn responses for blocks whose height is
