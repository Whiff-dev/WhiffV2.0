...
By default, whiffd will dump mempool on shutdown and
...
class MempoolPersistTest(WhiffTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give whiffd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent whiffd from writing mempool.dat to disk. Verify that `savemempool` fails")
