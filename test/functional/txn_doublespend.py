...
class TxnMallTest(WhiffTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 WFF:
        ...
        # First: use raw transaction API to send 1240 WFF to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 WFF coin each
        ...
        # Node0's balance should be starting balance, plus 50WFF for another
        ...
        # Node0's total balance should be starting balance, plus 100WFF for 
