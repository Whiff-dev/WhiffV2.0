...
class BIP66Test(WhiffTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # whiffd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and whiffd produces more specific reject
            # reasons.
