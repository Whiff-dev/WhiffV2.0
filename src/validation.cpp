...
#if defined(NDEBUG)
# error "Whiff cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Whiff Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s WFF additional fees, %d delta bytes\n",
