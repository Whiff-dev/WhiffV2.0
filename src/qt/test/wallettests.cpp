...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<WhiffAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_whiff-qt -platform xcb      # Linux
//     src/qt/test/test_whiff-qt -platform windows  # Windows
//     src/qt/test/test_whiff-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = WhiffUnits::formatWithUnit(unit, balance, false, WhiffUnits::separatorAlways);
    ...
    // Amount input
    WhiffAmountField* amountInput = receiveCoinsDialog.findChild<WhiffAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: whiff:")) != -1);
