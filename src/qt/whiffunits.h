...
#ifndef WHIFF_QT_WHIFFUNITS_H
#define WHIFF_QT_WHIFFUNITS_H
...
/** Whiff unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WhiffUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WhiffUnits(QObject *parent);

    /** Whiff units.
      @note Source: https://en.whiff.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WFF,
...
typedef WhiffUnits::Unit WhiffUnit;

#endif // WHIFF_QT_WHIFFUNITS_H
