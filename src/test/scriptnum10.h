...
#ifndef WHIFF_TEST_SCRIPTNUM10_H
#define WHIFF_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Whiff Core 0.10.0, for cross-comparison.
 */
public:
